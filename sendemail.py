...
class Mailer(object):
  ...
  def __init__(self,maillist,mailtitle,mailcontent):
    ...
    self.mail_user = "873118507"
    self.mail_pass = "jvykklgmpvylbfie"
  ...
  def sendMail(self):
    ...
    msg = MIMEMultipart()
    msg['Subject'] = currentTime+'质控城市接口测试'
    msg['From'] = me
...
#      首先是xlsx类型的附件
    xlsxpart = MIMEApplication(open('/Volumes/forWork/python/interfacetest/src/test_report/TestRunner.html', 'rb').read())
...
if __name__ == '__main__':
  ...
  mailto_list = ["lizelin_bj@126.com"]
  mail_title = '质控城市测试反馈'
  mail_content = ''
